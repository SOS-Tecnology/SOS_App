...
<head>
    <meta charset="UTF-8">
    <title>SOS-Nómina | Nueva contraseña</title>
...
<body class="min-h-screen flex items-center justify-center
    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <form method="POST" action="/reset-password/<?= htmlspecialchars($token) ?>" id="frm">
            ...
            <button type="submit"
                    class="w-full bg-teal-700 hover:bg-teal-800 text-white font-semibold py-2.5 rounded-lg transition text-sm">
                Guardar contraseña
            </button>
        </form>
        <p class="text-center text-sm text-gray-400 mt-5">
            <a href="/login" class="text-teal-700 hover:underline">← Volver</a>
        </p>
    </div>
    <script>
