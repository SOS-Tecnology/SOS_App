...
<div class="mb-5">
    ...
    <script>
        function validateDates() {
            var fechaDesde = document.querySelector('input[name="fecha_desde"]').value;
            var fechaHasta = document.querySelector('input[name="fecha_hasta"]').value;
        ...
        // El bloque Document Ready de Select2 se puede quedar exclusivamente abajo de todo de la página.
    </script>
    </form>
</div>
