...
<div class="max-w-lg mx-auto mt-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="/usuarios" class="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1">
    ...
    <form method="POST" action="/usuarios/store" id="form-usuario"
        ...
        <!-- Email -->
        <div class="px-6 py-5">
            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">Correo electrónico</label>
        ...
        <div class="px-6 py-5">
            ...
            <div class="relative">
                <input type="password" name="password" id="inp-password" required placeholder="Mínimo 8 caracteres"
                       class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm
                              focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent
        ...
        <div class="px-6 py-5">
            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">Confirmar contraseña</label>
            <input type="password" name="password_confirm" id="inp-confirm" required placeholder="Repite la contraseña"
                   class="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm
                          focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent
                          placeholder-gray-300 transition">
        ...
        <!-- Perfil -->
        <div class="px-6 py-5">
            <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">Perfil</label>
            ...
            <p class="text-xs text-gray-400 mt-1">
                Perfil de acceso. <a href="/perfiles/create" class="text-teal-600 hover:underline">Crear nuevo perfil</a>
            </p>
        </div>
...
document.getElementById('form-usuario').addEventListener('submit', function (e) {
    ...
    if (p1 !== p2) { msg.classList.remove('hidden'); e.preventDefault(); return; }
    msg.classList.add('hidden');
    if (p1.length < 8) { alert('La contraseña debe tener al menos 8 caracteres.'); e.preventDefault(); }
});
